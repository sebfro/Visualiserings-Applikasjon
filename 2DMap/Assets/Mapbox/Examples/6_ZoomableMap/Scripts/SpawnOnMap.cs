...
namespace Mapbox.Examples
{
    ...
    public class SpawnOnMap : MonoBehaviour
    {
        ...
        string[] SavedDir = Directory.GetFiles(Variables.SavedPathDirectory);
        ...
        void Start()
        {
            ...
            else if (SavedDir.Length != 0 && Variables.fullPath_Toggle.isOn)
            {
                pathToDirectory = SavedDir[0];
                GenerateFishRoute(pathToDirectory, false);
            }
            else
            {
        ...
        private void Update()
        {
            if (!Variables.missingTagFile)
            {
                ...
                if(Variables.savedFile)
                {
                    Variables.savedFile = false;
                    FishTagChanged();
                }
        ...
        void AddListeners()
        {
            ...
            Variables.morePaths_Toggle.onValueChanged.AddListener((value) =>
            {
                Util.MorePaths(value);
            });
            ...
            Variables.saved_Dropdown.onValueChanged.AddListener(delegate
            {
                DropdownValueChanged(Variables.saved_Dropdown, Variables.SavedPathDirectory);
            });

            Variables.savePath_Button.onClick.AddListener(delegate {Util.SavePath(pathToDirectory);});
        }
        ...
        void FishTagChanged()
        {
            ...
            try
            {
                ...
                SavedDir = Directory.GetFiles(Variables.SavedPathDirectory);
                upToDate = false;

                if(!Variables.PreviousSavedPath.Equals(""))
                {
                    pathToDirectory = Variables.PreviousSavedPath;
                    Variables.PreviousSavedPath = "";
                    GenerateFishRoute(pathToDirectory, false);
                }
                else if (ValidDir.Length != 0 && Variables.fullPath_Toggle.isOn)
                {
                    pathToDirectory = ValidDir[0];
                    GenerateFishRoute(pathToDirectory, false);
        ...
        void RefreshPathOptionsInDropdown()
        {
            ...
            Variables.saved_Dropdown.AddOptions(ReadFiles.ReadFishRoutesFromFileAndGenerateDropDownOptions(Variables.SavedPathDirectory));
        ...
        void RunAlgorithmWithNewParameters()
        {
            ...
            else
            {
                ...
                mProcess.StartInfo.FileName = @"C:\Users\sebas\Documents\GitHub\SDSLiteVS2017\SpagettiMetoden\bin\x64\Debug\SpagettiMetoden.exe";
